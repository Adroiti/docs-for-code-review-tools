Pattern: Inconsistent extension in `@import`

Issue: -

## Description

Requires or disallows extension in `@import` commands.
...
* [stylelint - at-import-partial-extension](https://github.com/kristerkari/stylelint-scss/tree/master/src/rules/at-import-partial-extension)