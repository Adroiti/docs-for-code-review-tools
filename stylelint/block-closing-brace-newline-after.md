Pattern: Malformed newline after `}` of block

Issue: -

## Description

Require a newline or disallow whitespace after the closing brace of blocks. This rule allows an end-of-line comment separated from the closing brace by spaces, as long as the comment contains no newlines. For example:
