Pattern: Unexpected non-standard direction
...
* [stylelint - function-linear-gradient-no-nonstandard-direction](https://stylelint.io/user-guide/rules/function-linear-gradient-no-nonstandard-direction)