Pattern: Missing block for `Rails.logger.debug`
...
* [RuboCop - Rails/EagerEvaluationLogMessage](https://docs.rubocop.org/rubocop-rails/cops_rails.html#railseagerevaluationlogmessage)
